              ...
              <div className="flex items-end justify-center gap-2 pt-3 pb-2 px-2 border-b border-[#182645]/60">
                ...
                {top3[1] && (
                  <div className="flex flex-col items-center">
                    <span className="text-[10px] font-semibold text-slate-400 mb-1 truncate max-w-[60px]">
                      {top3[1].firstName}
                    </span>
                ...
                {top3[0] && (
                  <div className="flex flex-col items-center">
                    ...
                    <span className="text-[10px] font-bold text-amber-300 mb-1 truncate max-w-[65px]">
                      {top3[0].firstName}
                    </span>
