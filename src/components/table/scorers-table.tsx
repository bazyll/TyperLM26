    ...
    return (
      <div className="flex flex-col items-center justify-center p-12 rounded-3xl border border-slate-800 bg-slate-900/90 text-center shadow-xl">
        ...
        <p className="text-xs sm:text-sm text-slate-400 max-w-sm">
          Statystyki strzelców pojawią się po rozegraniu pierwszych meczów.
        </p>
      </div>
    );
  }
        ...
        <table className="w-full text-left text-xs sm:text-sm">
          <thead className="bg-slate-950 text-slate-400 font-semibold border-b border-slate-800 text-[11px] sm:text-xs">
            <tr>
              ...
              <th className="py-3 px-3 sm:px-4 text-center">Asysty</th>
              <th className="py-3 px-3 sm:px-4 text-right">Gole</th>
            </tr>
          </thead>
              ...
              return (
                ...
                >
                  ...
                  <td className="py-2.5 px-3 sm:px-4 text-right">
                    <Badge className="bg-blue-600/30 border border-blue-500/50 text-blue-300 font-extrabold text-xs px-2.5 py-0.5">
                      {player.goalsCount}
                    </Badge>
                  </td>
                </tr>
